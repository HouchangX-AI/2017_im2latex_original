...
def edit_distance(target_formulas_file, predicted_formulas_file):
    ...
    a = "{}/{}".format(n, n)
    Edit_Distance_Accuracy = (1. - float(total_edit_distance) / total_len)
    print("{}/{}".format(n, n))
    print('Edit Distance Accuracy: %f' % (1. - float(total_edit_distance) / total_len))
    return Edit_Distance_Accuracy
#
